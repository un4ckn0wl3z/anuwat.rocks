...
wait(2000)
	.then(() => glitchWrite(glitch_this, 'To Anuwat.Rocks', ))
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'The owner of this is site is Anuwat Khongchuai.'))
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'or un4ckn0wl3z for my ScreenName.'))
	.then(() => wait(2000))
	...
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'Facebook: https://www.facebook.com/un4ckn0wl3z'))
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'GitHub: https://github.com/un4ckn0wl3z'))
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'Twitter: https://twitter.com/haxtivitiez'))
	.then(() => wait(2000))
	.then(() => glitchWrite(glitch_this, 'Blog: https://haxtivitiez.wordpress.com/'))
	.then(() => wait(2000))
